                ...
                <div className="w-full flex flex-col items-center justify-center bg-sekunder-60 p-5">
                    <div className="max-w-md w-full">
                        ...
                        <div className="w-full pt-20">
                            <div className="bar">
                                <div className="bar-fill bar-fill-4 start"></div>
                            </div>
                        </div>
                        ...
                        <div className='bg-white bg-opacity-80 mt-7 flex rounded-xl mx-auto w-[330px]'>
                            <p className='text-center text-sm p-5 md:text-xl font-bold'>Bagaimana kualitas permainan wahana kami?</p>
                        </div>
                    </div>
                </div>
            </section>
...
export default SesiSatuSurveyEmpat;