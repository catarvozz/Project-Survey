    ...
    return (
        <>
                ...
                <div className="w-full flex flex-col items-center justify-center bg-sekunder-60 p-5">
                    <div className="max-w-md w-full">
                        ...
                        <div className="w-full pt-20">
                            <div className="bar">
                                <div className="bar-fill bar-fill-2 start"></div>
                            </div>
                        </div>
                        ...
                        <div className='bg-white bg-opacity-80 mt-7 flex rounded-xl mx-auto w-[330px]'>
                            <p className='text-center text-sm p-5 md:text-xl font-bold'>Bagaimana fasilitas dan kebersihan area kami?(fasum, resto, dll)</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div className='flex flex-col items-center min-h-screen h-full bg-gray-50 font-Poppins'>
                <div className='absolute w-[330px] md:w-[450px] bg-gradient-to-r from-primer-40 via-primer-80 to-primer-60 rounded-xl text-white md:p-10 flex flex-col items-center gap-5 mt-7 md:mt-10'>
                    <button
                    onClick={() => goNavigate()} 
...
export default SesiSatuSurveyDua;