    ...
    return (
        <>
            ...
            <div className='flex flex-col items-center min-h-screen h-full bg-gray-50 font-Poppins'>
                ...
                <div className='absolute w-[330px] md:w-[450px] bg-gray-50 md:p-10 flex flex-col items-center gap-5 mt-12 md:mt-10'>
                    <p className=' text-center text-sm p-5 md:text-xl font-bold text-black'>Sudah berapa kali anda berkunjung ke saloka?</p>
                    <button
                        onClick={() => goNavigate()}
                        ...
                        <span className='ml-10'>1 kali</span>
                    </button>
                    <button
                        onClick={() => goNavigate()}
                        className='rounded-full bg-white text-black mb-4 p-3 w-[250px] md:w-full h-20 shadow-md shadow-gray-400 flex items-center'>
                        ...
                        <span className='ml-10'>2 kali</span>
                    </button>
                    <button
                        onClick={() => goNavigate()}
                        className='rounded-full bg-white text-black mb-4 p-3 w-[250px] md:w-full h-20 shadow-md shadow-gray-400 flex items-center'>
                        ...
                        <span className='ml-10'>lebih dari 3 kali</span>
                    </button>
                </div>
            </div>
        </>
...
export default SesiDuaKunjunganSatu;